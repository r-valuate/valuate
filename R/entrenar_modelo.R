...
#'                 dependiente = "vut",
#'                 independientes = c(system.file("inst/extdata/dist_basura.tif", package = "valuate"),
#'                                    system.file("inst/extdata/dist_industria.tif", package = "valuate"),
#'                                    system.file("inst/extdata/dist_plazas_parques.tif", package = "valuate"),
#'                                    system.file("inst/extdata/dist_tren.tif", package = "valuate"),
#'                                    system.file("inst/extdata/dist_vias_autopista.tif", package = "valuate"),
#'                                    system.file("inst/extdata/dist_vias_prim.tif", package = "valuate"),
#'                                    system.file("inst/extdata/dist_vias_sec.tif", package = "valuate"),
#'                                    system.file("inst/extdata/entorno_altura.tif", package = "valuate"),
#'                                    system.file("inst/extdata/entorno_plazas_parques.tif", package = "valuate"),
#'                                    system.file("inst/extdata/entorno_comercios.tif", package = "valuate"),
#'                                    system.file("inst/extdata/entorno_edificaciones.tif", package = "valuate"),
#'                                    system.file("inst/extdata/entorno_hoteles.tif", package = "valuate")),
#'                 modelo = "qrf",
#'                 umbral = 0.3)
